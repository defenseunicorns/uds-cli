...
func TestTaskRunner(t *testing.T) {
	...
	t.Run("propagate normalized feature gates", func(t *testing.T) {
		...
		require.NoError(t, err, stdout, stderr)
		require.Contains(t, stderr, "NextMode=false")
	})
	...
	t.Run("run remote-import", func(t *testing.T) {
		...
		stdOut, stdErr, err := e2e.UDS("run", "remote-import", "--set", setVar, "--file", "testdata/legacy/tasks/remote-tasks.yaml")
		require.NoError(t, err, stdOut, stdErr)
	...
	t.Run("test action with multiple include tasks", func(t *testing.T) {
		...
		stdOut, stdErr, err := e2e.UDS("run", "more-foobar", "--set", setVar, "--file", "testdata/legacy/tasks/remote-tasks.yaml")
		require.NoError(t, err, stdOut, stdErr)
		require.Contains(t, stdErr, "echo foo")
		require.Contains(t, stdErr, "echo bar")
		require.Contains(t, stdErr, "defenseunicorns is a pretty ok company")
	...
	t.Run("test action with multiple nested include tasks", func(t *testing.T) {
		...
		stdOut, stdErr, err := e2e.UDS("run", "extra-foobar", "--set", setVar, "--file", "testdata/legacy/tasks/remote-tasks.yaml")
		require.NoError(t, err, stdOut, stdErr)
		require.Contains(t, stdErr, "echo foo")
		require.Contains(t, stdErr, "echo bar")
	...
	t.Run("run list tasks", func(t *testing.T) {
		t.Parallel()
		stdOut, stdErr, err := e2e.UDS("run", "--list", "--file", "testdata/legacy/tasks/tasks.yaml")
		require.NoError(t, err, stdOut, stdErr)
