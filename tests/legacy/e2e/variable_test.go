...
func TestBundleVariables(t *testing.T) {
	...
	e2e.CreateZarfPkg(t, "testdata/legacy/packages/no-cluster/receive-var", false)
	os.Setenv("UDS_ANIMAL", "Unicorns")
	os.Setenv("UDS_CONFIG", filepath.Join("testdata/legacy/bundles/02-variables", "uds-config.yaml"))
	...
	t.Run("bad var name in import", func(t *testing.T) {
		bundleDir := "testdata/legacy/bundles/02-variables/bad-var-name"
	...
	t.Run("var name collision with exported vars", func(t *testing.T) {
		e2e.CreateZarfPkg(t, "testdata/legacy/packages/no-cluster/output-var-collision", false)
		bundleDir := "testdata/legacy/bundles/02-variables/export-name-collision"
...
func TestBundleWithHelmOverridesValuesFile(t *testing.T) {
	...
	e2e.HelmDepUpdate(t, "testdata/legacy/packages/helm/unicorn-podinfo")
	e2e.CreateZarfPkg(t, "testdata/legacy/packages/helm", false)
	bundleDir := "testdata/legacy/bundles/07-helm-overrides/values-file"
...
func TestBundleWithDupPkgs(t *testing.T) {
	...
	bundleDir := "testdata/legacy/bundles/07-helm-overrides/duplicate"
...
func TestBundleWithPackageNamespaceOverride(t *testing.T) {
	...
	bundleDir := "testdata/legacy/bundles/07-helm-overrides/package-namespace"
...
func TestVariablePrecedence(t *testing.T) {
	...
	e2e.CreateZarfPkg(t, "testdata/legacy/packages/helm", false)
	e2e.CreateZarfPkg(t, "testdata/legacy/packages/no-cluster/output-var", false)
	bundleDir := "testdata/legacy/bundles/08-var-precedence"
	bundlePath := filepath.Join(bundleDir, fmt.Sprintf("uds-bundle-var-precedence-%s-0.0.1.tar.zst", e2e.Arch))
	err := os.Setenv("UDS_CONFIG", filepath.Join("testdata/legacy/bundles/08-var-precedence", "uds-config.yaml"))
	require.NoError(t, err)
	runCmd(t, fmt.Sprintf("create %s --insecure --confirm -a %s", bundleDir, e2e.Arch))
...
func TestExportVarsAsGlobalVars(t *testing.T) {
	...
	e2e.HelmDepUpdate(t, "testdata/legacy/packages/helm/unicorn-podinfo")
	e2e.CreateZarfPkg(t, "testdata/legacy/packages/helm", false)
	bundleDir := "testdata/legacy/bundles/12-exported-pkg-vars"
