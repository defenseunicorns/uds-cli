...
func TestUDSLogs(t *testing.T) {
	zarfPkgPath := "testdata/legacy/packages/no-cluster/real-simple"
	e2e.CreateZarfPkg(t, zarfPkgPath, false)
	runCmd(t, fmt.Sprintf("create testdata/legacy/bundles/11-real-simple --insecure --confirm -a %s", e2e.Arch))
...
func TestSimpleBundleWithZarfAction(t *testing.T) {
	...
	e2e.CreateZarfPkg(t, zarfPkgPath, false)
	runCmd(t, fmt.Sprintf("create testdata/legacy/bundles/11-real-simple --insecure --confirm -a %s", e2e.Arch))
	tarballPath := fmt.Sprintf("testdata/legacy/bundles/11-real-simple/uds-bundle-real-simple-%s-0.0.1.tar.zst", e2e.Arch)
...
func TestSimpleBundleWithNameAndVersionFlags(t *testing.T) {
	...
	bundlePath := "testdata/legacy/bundles/11-real-simple"
	runCmd(t, fmt.Sprintf("create %s --confirm --name %s --version %s", bundlePath, name, version))
	tarballPath := fmt.Sprintf("testdata/legacy/bundles/11-real-simple/uds-bundle-%s-%s-%s.tar.zst", name, e2e.Arch, version)
...
func TestCreateWithNoPath(t *testing.T) {
	...
	zarfPkgPath1 := "testdata/legacy/packages/no-cluster/output-var"
	zarfPkgPath2 := "testdata/legacy/packages/no-cluster/receive-var"
	...
	err := os.Link(fmt.Sprintf("testdata/legacy/bundles/02-variables/remote/%s", config.BundleYAML), config.BundleYAML)
	require.NoError(t, err)
...
func TestCreateRemotePackageWithoutPublicKey(t *testing.T) {
	bundleDir := "testdata/legacy/bundles/20-signed-no-key"
...
func TestCreateBundleWithInvalidPackageTimeout(t *testing.T) {
	bundleDir := "testdata/legacy/bundles/22-invalid-timeout"
...
func TestLocalBundleWithRemotePkgs(t *testing.T) {
	...
	e2e.CreateZarfPkg(t, "testdata/legacy/packages/nginx", false)
	e2e.CreateZarfPkg(t, "testdata/legacy/packages/podinfo", false)
	...
	pkg := fmt.Sprintf("testdata/legacy/packages/nginx/zarf-package-nginx-%s-0.0.1.tar.zst", e2e.Arch)
	runCmd(t, fmt.Sprintf("zarf package publish %s oci://localhost:888 --plain-http --oci-concurrency=10 -l debug", pkg))

	pkg = fmt.Sprintf("testdata/legacy/packages/podinfo/zarf-package-podinfo-%s-0.0.1.tar.zst", e2e.Arch)
	runCmd(t, fmt.Sprintf("zarf package publish %s oci://localhost:889 --plain-http --oci-concurrency=10 -l debug", pkg))

	bundleDir := "testdata/legacy/bundles/01-uds-bundle"
...
func TestRemoteBundleWithRemotePkgs(t *testing.T) {
	...
	bundlePath := "testdata/legacy/bundles/01-uds-bundle"
...
func TestRemoteBundleWithMultiPlatformImageIndex(t *testing.T) {
	...
	zarfPkgPath := "testdata/legacy/packages/multi-platform-image"
	...
	bundleDir := "testdata/legacy/bundles/23-multi-platform-image"
...
func TestBundleWithGitRepo(t *testing.T) {
	deployZarfInit(t)
	e2e.CreateZarfPkg(t, "testdata/legacy/packages/gitrepo", false)
	bundleDir := "testdata/legacy/bundles/05-gitrepo"
...
func TestBundleWithYmlFile(t *testing.T) {
	deployZarfInit(t)
	e2e.CreateZarfPkg(t, "testdata/legacy/packages/nginx", true)

	bundleDir := "testdata/legacy/bundles/09-uds-bundle-yml"
	...
	os.Setenv("UDS_CONFIG", filepath.Join("testdata/legacy/bundles/09-uds-bundle-yml", "uds-config.yml"))
...
func TestLocalBundleWithOutput(t *testing.T) {
	path := "testdata/legacy/packages/nginx"
	e2e.CreateZarfPkg(t, path, false)

	bundleDir := "testdata/legacy/bundles/09-uds-bundle-yml"
	destDir := "testdata/legacy/test/"
...
func TestInspectBundleSignedWithKeyScenarios(t *testing.T) {
	bundleDir := "testdata/legacy/bundles/21-signed-with-key"
...
func TestSimplePackagesWithSBOMs(t *testing.T) {
	...
	e2e.CreateZarfPkg(t, "testdata/legacy/packages/no-cluster/real-simple", false)

	bundleDir := "testdata/legacy/bundles/11-real-simple/multiple-simple"
...
func TestPackageNaming(t *testing.T) {
	...
	bundleDir := "testdata/legacy/bundles/10-package-naming"
...
func TestBundleWithComposedPkgComponent(t *testing.T) {
	...
	e2e.SetupDockerRegistry(t, 888)
	defer e2e.TeardownRegistry(t, 888)
	zarfPkgPath := "testdata/legacy/packages/prometheus"
	pkg := filepath.Join(zarfPkgPath, fmt.Sprintf("zarf-package-prometheus-%s-0.0.1.tar.zst", e2e.Arch))
	e2e.CreateZarfPkg(t, zarfPkgPath, false)
	runCmd(t, fmt.Sprintf("zarf package publish %s oci://localhost:888 --plain-http --oci-concurrency=10 -l debug", pkg))

	bundleDir := "testdata/legacy/bundles/13-composable-component"
...
func TestInvalidConfig(t *testing.T) {
	os.Setenv("UDS_CONFIG", filepath.Join("testdata/legacy/bundles/07-helm-overrides", "uds-config-invalid.yaml"))
	defer os.Unsetenv("UDS_CONFIG")
	zarfPkgPath := "testdata/legacy/packages/helm"
...
func TestInvalidBundle(t *testing.T) {
	...
	e2e.HelmDepUpdate(t, fmt.Sprintf("%s/unicorn-podinfo", zarfPkgPath))
	e2e.CreateZarfPkg(t, zarfPkgPath, false)
	bundleDir := "testdata/legacy/bundles/07-helm-overrides/invalid"
...
func TestArchCheck(t *testing.T) {
	...
	bundleDir := "testdata/legacy/bundles/07-helm-overrides"
...
func TestListImages(t *testing.T) {
	...
	zarfPkgPath = "testdata/legacy/packages/podinfo-nginx"
	e2e.CreateZarfPkg(t, zarfPkgPath, false)

	bundleDir := "testdata/legacy/bundles/14-optional-components"
...
func TestBundleWithComponentNamedAuth(t *testing.T) {
	zarfPkgPath := "testdata/legacy/packages/zarf-bug"
	e2e.CreateZarfPkg(t, zarfPkgPath, false)

	bundleDir := "testdata/legacy/bundles/16-zarf-bug"
...
func TestBundleWithImageRef(t *testing.T) {
	zarfPkgPath := "testdata/legacy/packages/podinfo-refs"
	e2e.CreateZarfPkg(t, zarfPkgPath, false)

	e2e.SetupDockerRegistry(t, 888)
	defer e2e.TeardownRegistry(t, 888)

	bundleDir := "testdata/legacy/bundles/19-zarf-image-ref"
