...
Define a bundle in Next mode with HCL and create a self-contained OCI artifact. Name the definition file `bundle.uds.hcl`.

## What you'll accomplish

Define package sources and dependencies, add values files, and create a signed or unsigned artifact.
