...
<CardGrid>
  <LinkCard
    ...
    href="/how-to-guides/use-bundle-overrides/"
    description="Customize package configuration at deploy time without modifying the bundle."
  />
  <LinkCard
    title="Use UDS Runner"
    href="/how-to-guides/use-uds-runner/"
    description="Automate tasks with UDS Runner's built-in task execution."
  />
  <LinkCard
    title="Monitor a Cluster"
    href="/how-to-guides/monitor-cluster/"
    description="Inspect running workloads and Pepr events from the CLI."
  />
</CardGrid>
