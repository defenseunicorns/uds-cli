...
go run ./cmd/uds --cli-mode legacy internal config-uds-schema > uds.schema.json
...
go run ./cmd/uds --cli-mode legacy internal config-tasks-schema > tasks.schema.json
...
curl -O https://raw.githubusercontent.com/zarf-dev/zarf/v0.82.0/zarf.schema.json
