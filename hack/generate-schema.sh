...
go run ./cmd/uds --feature-gates=NextMode=false internal config-uds-schema > uds.schema.json
...
go run ./cmd/uds --feature-gates=NextMode=false internal config-tasks-schema > tasks.schema.json
...
curl -O https://raw.githubusercontent.com/zarf-dev/zarf/v0.83.0/zarf.schema.json
