...
func init() {
	...
	createCmd.Flags().StringVarP(&bundleCfg.CreateOpts.Version, "version", "n", "", lang.CmdBundleCreateFlagVersion)
	createCmd.Flags().StringVarP(&bundleCfg.CreateOpts.Name, "name", "v", "", lang.CmdBundleCreateFlagName)
