...
type tarballPkgProvider struct {
	ctx          context.Context
	tarballSrc   string
	extractedDst string
}

func (tp *tarballPkgProvider) GetMetadata(pathToTarball string, tmpDir string) (zarfTypes.ZarfPackage, error) {
...
func (tp *tarballPkgProvider) Extract() error {
...
func (tp *tarballPkgProvider) Load() (zarfTypes.ZarfPackage, error) {
...
func (tp *tarballPkgProvider) ToBundle(bundleStore *ocistore.Store, pkg zarfTypes.ZarfPackage, artifactPathMap map[string]string, bundleTmpDir string, packageTmpDir string) (ocispec.Descriptor, error) {
