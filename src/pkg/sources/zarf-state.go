...
// NewZarfStateSource creates a new ZarfState package source
// only used for remove operations on prune
func NewZarfStateSource(client kubernetes.Interface, pkgName string) (*ZarfState, error) {
	// get secret from K8s
