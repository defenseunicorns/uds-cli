...
const (
	...
	CmdBundleDeployFlagComponents = "Specify which zarf packages components you would like to deploy from the bundle. By default the default zarf packages components in the bundle are deployed."
