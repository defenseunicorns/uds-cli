...
func addBundleCommands(rootCmd *cobra.Command) {
	...
	deployCmd.Flags().BoolVar(&bundleCfg.DeployOpts.ForceConflicts, "force-conflicts", false, lang.CmdBundleDeployFlagForceConflicts)
