...
// packageSignatureVerificationOptions translates package HCL verification
// settings into the Zarf package-layout options that perform verification.
func packageSignatureVerificationOptions(pkg *Package, verificationDir, tmpDir string) (layout.PackageLayoutOptions, error) {
	if pkg == nil {
...
func advisoryVerifyPackage(ctx context.Context, pkgLayout *layout.PackageLayout, pkg *Package, tmpDir string, streams iostreams.IOStreams) {
