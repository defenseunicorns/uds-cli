...
const (
	...
	// TrustedRootFile is the name of the Sigstore TrustedRoot JSON file
	...
	// CLIModeEnvVar selects the UDS CLI implementation.
	CLIModeEnvVar = "UDS_CLI_MODE"
...
// IsReservedEnvVar reports whether an environment variable controls the UDS process.
func IsReservedEnvVar(name string) bool {
	_, reserved := reservedEnvVars[name]
	return reserved
}
